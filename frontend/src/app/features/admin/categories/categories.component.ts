      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div
          *ngFor="let category of categories"
          class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-4 hover:shadow-md transition-shadow relative"
        >
          <div
            class="size-12 rounded-xl bg-blue-50 overflow-hidden flex items-center justify-center"
          >
            <img
            ...
            />
            <span *ngIf="!category.imageUrl" class="material-symbols-outlined text-primary"
              >category</span
            >
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
          ...
          <div class="p-6 space-y-4">
            ...
            <div>
              ...
              >
              <input
                [(ngModel)]="currentCategory.imageUrl"
                class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary outline-none"
            ...
            <div class="flex items-center gap-3">
              ...
              />
              <label for="categoryActive" class="text-sm font-bold text-gray-700"
  ...
  saveCategory() {
    if (this.currentCategory.id) {
      this.categoryService
        .updateCategory(this.currentCategory.id, {
