      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div
          *ngFor="let product of products"
          class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-3 hover:shadow-md transition-shadow relative"
        >
            ...
            <div class="flex flex-col items-end gap-1">
              <span
                *ngIf="!product.isActive"
                class="px-1.5 py-0.5 rounded-md bg-amber-50 text-amber-600 text-[10px] font-bold uppercase"
                >Inactive</span
              >
              <span
                *ngIf="product.isFeatured"
                class="px-1.5 py-0.5 rounded-md bg-blue-50 text-blue-600 text-[10px] font-bold uppercase"
                >Featured</span
              >
            </div>
          </div>
          <div class="text-sm text-gray-600">
            Price:
            <span class="font-semibold text-gray-800">{{ product.price | number: '1.0-0' }}</span>
          </div>
          <div class="text-sm text-gray-600">
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-6">
              <div class="flex items-center gap-2">
                ...
                />
                <label for="productActive" class="text-sm font-bold text-gray-700"
              ...
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="size-4 rounded border-gray-300 text-primary focus:ring-primary"
                />
                <label for="productFeatured" class="text-sm font-bold text-gray-700"
...
export class AdminProductsComponent implements OnInit {
  ...
  saveProduct() {
    const payload = {
      ...
      isFeatured: this.currentProduct.isFeatured,
    };
